...
CREATE TABLE IF NOT EXISTS t_user (
    ...
    gender            TINYINT      DEFAULT NULL COMMENT '性别 0不填 1男 2女',
    school            VARCHAR(80)  DEFAULT NULL COMMENT '学校/单位',
    major             VARCHAR(80)  DEFAULT NULL COMMENT '学院/专业',
    city              VARCHAR(40)  DEFAULT NULL COMMENT '常驻城市',
